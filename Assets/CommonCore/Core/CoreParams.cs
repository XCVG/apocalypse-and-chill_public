...
namespace CommonCore
{
    ...
    public static partial class CoreParams
    {
        ...
        public static string GameVersionName { get; private set; } = "main";
        ...
        public static bool UseMigrationBackups { get; private set; } = false; //if set, will save backups before migrating

        public static bool SetSafeResolutionOnExit { get; private set; } = true;
        public static Vector2Int SafeResolution { get; private set; } = new Vector2Int(854, 480);
        public static bool SetNativeResolutionOnFirstRun { get; private set; } = false;

        public static UIThemePolicy UIThemeMode { get; private set; } = UIThemePolicy.Auto;
        public static string DefaultUITheme { get; private set; } = "ThresholdGrayTheme";
        ...
        public static string InitialScene { get; private set; } = "AncMainScene";
